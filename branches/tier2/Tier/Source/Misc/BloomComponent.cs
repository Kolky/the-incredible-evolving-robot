...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        public BloomComponent(TierGame game)
            : base(game)
        {
            if (game == null)
        ...
        protected override void LoadContent()
        {
            ...
            renderTarget1 = new RenderTarget2D(GraphicsDevice, width, height, 1, format, pp.MultiSampleType, pp.MultiSampleQuality);
            renderTarget2 = new RenderTarget2D(GraphicsDevice, width, height, 1, format, pp.MultiSampleType, pp.MultiSampleQuality);                
        }

        /// <summary>
        /// Resets extract effect to bloom only pixels with a certain alpha value
        /// </summary>
        public void ResetFullscreen()
        {
          this.bloomExtractEffect.CurrentTechnique = this.bloomExtractEffect.Techniques["Default"];
        }

        /// <summary>
        /// Sets extract effect to bloom all pixels
        /// </summary>
        public void SetFullscreen()
        {
          this.bloomExtractEffect.CurrentTechnique = this.bloomExtractEffect.Techniques["FullscreenBloom"];
        }
