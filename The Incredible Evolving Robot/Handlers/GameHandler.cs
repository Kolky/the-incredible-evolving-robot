...
namespace Tier.Handlers
{
  public class GameHandler
  {
    ...
    public void LoadGraphicsContent(Boolean loadAllContent)
    {
      ...
      {
        // Blocks
        TierGame.ContentHandler.setModel("Bar", TierGame.Content.Load<Model>("Content//Models//Bar"));
        TierGame.ContentHandler.setModel("L", TierGame.Content.Load<Model>("Content//Models//L"));
        TierGame.ContentHandler.setModel("Globe", TierGame.Content.Load<Model>("Content//Models//Globe"));
        TierGame.ContentHandler.setModel("Boss", TierGame.Content.Load<Model>("Content//Models//TierCore"));
        TierGame.ContentHandler.setModel("Cross", TierGame.Content.Load<Model>("Content//Models//Cross"));
        TierGame.ContentHandler.setModel("Nico", TierGame.Content.Load<Model>("Content//Models//Nico"));
        TierGame.ContentHandler.setModel("T", TierGame.Content.Load<Model>("Content//Models//T"));
        TierGame.ContentHandler.setModel("Cube", TierGame.Content.Load<Model>("Content//Models//Cube"));
        // Sphere
        TierGame.ContentHandler.setModel("Sphere", TierGame.Content.Load<Model>("Content//Models//SphereConnector"));
        // Player
				TierGame.ContentHandler.setModel("Ship", TierGame.Content.Load<Model>("Content//Models//Ship"));
        // Weapons
        TierGame.ContentHandler.setModel("Laser", TierGame.Content.Load<Model>("Content//Models//Laser"));
        TierGame.ContentHandler.setModel("LaserGun", TierGame.Content.Load<Model>("Content//Models//LaserGun"));
        //TierGame.ContentHandler.setModel("DoubleBullet", TierGame.Content.Load<Model>("Content//Models//DoubleBullet"));
        TierGame.ContentHandler.setModel("DoubleBulletTurret", TierGame.Content.Load<Model>("Content//Models//DoubleBulletTurret"));
				TierGame.ContentHandler.setModel("RocketTurret", TierGame.Content.Load<Model>("Content//Models//RocketTurret"));
        TierGame.ContentHandler.setModel("Laserbeam", TierGame.Content.Load<Model>("Content//Models//Laserbeam"));
        TierGame.ContentHandler.setModel("LaserbeamTurret", TierGame.Content.Load<Model>("Content//Models//LaserbeamTurret"));
        ...
        TierGame.ContentHandler.setEffect("BlockEffect", TierGame.Content.Load<Effect>("Content//Effects//Blocks"));
