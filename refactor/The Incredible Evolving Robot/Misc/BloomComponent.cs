  ...
  public class BloomComponent : DrawableGameComponent
  {
    ...
    protected override void LoadGraphicsContent(bool loadAllContent)
    {
      if (loadAllContent)
      {
        ...
        this.bloomExtractEffect = TierGame.Content.Load<Effect>("Content/Effects/BloomExtract");
        this.bloomCombineEffect = TierGame.Content.Load<Effect>("Content/Effects/BloomCombine");
        this.gaussianBlurEffect = TierGame.Content.Load<Effect>("Content/Effects/GaussianBlur");
      }
